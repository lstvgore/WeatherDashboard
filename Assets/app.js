...
button.addEventListener('click', function (event) {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q=' + city + '&units=imperial&appid=1110a537a5d0dc6edde7bf296b840bde')
        ...
        .then(data => {
            ...
            var inputValue = document.querySelector('.Submit');
            var city = inputValue.value
            fetch('https://api.openweathermap.org/data/2.5/forecast?q=' + city + '&appid=1110a537a5d0dc6edde7bf296b840bde')
                .then(data => {
                    console.log(data) })
